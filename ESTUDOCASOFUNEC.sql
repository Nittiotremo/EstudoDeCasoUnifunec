...
INSERT INTO FUNCIONARIOS (NOMEFUNCIONARIO,NUMEROCASA,SALARIOFUNCIONARIO) VALUES ('CARLOS',123,1200)
INSERT INTO FUNCIONARIOS (NOMEFUNCIONARIO,NUMEROCASA,SALARIOFUNCIONARIO) VALUES ('ROBERTO',321,1200)
INSERT INTO FUNCIONARIOS (NOMEFUNCIONARIO,NUMEROCASA,SALARIOFUNCIONARIO) VALUES ('XAVIER',456,1200)
INSERT INTO FUNCIONARIOS (NOMEFUNCIONARIO,NUMEROCASA,SALARIOFUNCIONARIO) VALUES ('JOAO',789,1200)
SELECT * FROM FUNCIONARIOS

SELECT * FROM RUA
INSERT INTO RUA (NOMERUA) VALUES ('RUA ESPANHA')

SELECT * FROM BAIRRO
INSERT INTO BAIRRO (NOMEBAIRRO) VALUES ('JARDIM EUROPA')

SELECT * FROM CEP
INSERT INTO CEP (NUMEROCEO) VALUES ('')

SELECT * FROM CIDADE
INSERT INTO CIDADE (NOMECIDADE, CODUF_FK) VALUES ('SÃO PAULO',1)

SELECT * FROM UF
INSERT INTO UF (NOMEUF, SIGLA) VALUES ('SAO PAULO','SP')

SELECT * FROM FUNCAO
INSERT INTO FUNCAO (NOMEFUNCAO) VALUES ('CAIXA')

SELECT * FROM LOJA
INSERT INTO LOJA (NOMELOJA,CNPJ,NOMEFANTASIA,RAZAOSOCIAL) VALUES ('LOJA UNIFUNEC','31444122000109','LOJA UNIFUNEC','LOJAFUNEC')
...
SELECT COUNT(NOMEFUNCIONARIO) FROM FUNCIONARIOS

--2) LISTE QUANTOS CLIENTES A LOJA UNIFUNEC POSSUI.
INSERT INTO CLIENTE (NOMECLIENTE,DATANASC,SALARIOCLIENTE,NUMEROCASA) VALUES ('ROBERTO','2023-03-10',1300,300)
INSERT INTO CLIENTE (NOMECLIENTE,DATANASC,SALARIOCLIENTE,NUMEROCASA) VALUES ('JEFFERSON','2023-09-16',1400,500)
INSERT INTO CLIENTE (NOMECLIENTE,DATANASC,SALARIOCLIENTE,NUMEROCASA) VALUES ('BETO','2023-12-12',1700,344)
INSERT INTO CLIENTE (NOMECLIENTE,DATANASC,SALARIOCLIENTE,NUMEROCASA) VALUES ('CASEMIRO','2023-02-25',1100,55)


SELECT COUNT(NOMECLIENTE) FROM CLIENTE
--3) INFORME O VALOR DO MAIOR SALÁRIO DO FUNCIONÁRIO DA LOJA.
SELECT MAX(SALARIOFUNCIONARIO) FROM FUNCIONARIOS
/*4) INFORME O MAIOR E MENOR CÓDIGO DAS CIDADES DO CADASTRADAS NO
BANCO DE DADOS.*/
INSERT INTO CIDADE (NOMECIDADE,CODUF_FK) VALUES ('SÃO PAULO',2)
INSERT INTO CIDADE (NOMECIDADE,CODUF_FK) VALUES ('MINAS GERAIS',3)
INSERT INTO CIDADE (NOMECIDADE,CODUF_FK) VALUES ('RIO DE JANEIRO',4)
INSERT INTO CIDADE (NOMECIDADE,CODUF_FK) VALUES ('PIAUÍ',5)
INSERT INTO CIDADE (NOMECIDADE,CODUF_FK) VALUES ('RIO GRANDE DO SUL',6)

SELECT MAX(CODCIDADE) FROM CIDADE

SELECT * FROM CIDADE
--5) INFORME A SOMA DE TODOS OS SALÁRIOS DOS FUNCIONÁRIOS DA LOJA.
SELECT SUM(SALARIOFUNCIONARIO) FROM FUNCIONARIOS
SELECT SUM(SALARIOCLIENTE) FROM CLIENTE


--6) IMPRIMA A MÉDIA DE TODOS OS SALÁRIOS DA LOJA.
SELECT SUM(SALARIOFUNCIONARIO + SALARIOCLIENTE) FROM FUNCIONARIOS,CLIENTE
...
INSERT INTO TIPO (NOMETIPO) VALUES ('GRÃO')
SELECT* FROM TIPO

INSERT INTO PRODUTO (NOMEPRODUTO,QUANTIDADE,VALOR,CODMARCA_FK,CODTIPO_FK) VALUES ('PIPOCA',30,7,1,1,1)
INSERT INTO PRODUTO (NOMEPRODUTO,QUANTIDADE,VALOR,CODMARCA_FK,CODTIPO_FK) VALUES ('PIPOCA',30,7,1,1,1)
INSERT INTO PRODUTO (NOMEPRODUTO,QUANTIDADE,VALOR,CODMARCA_FK,CODTIPO_FK) VALUES ('PIPOCA',30,7,1,1,1)
...
ESTE PERTENCE.*/
INSERT INTO UF (NOMEUF,SIGLA) VALUES ('SP','SP') --1
INSERT INTO UF (NOMEUF,SIGLA) VALUES ('MG','MG') --2
INSERT INTO UF (NOMEUF,SIGLA) VALUES ('RJ','RJ') --3
INSERT INTO UF (NOMEUF,SIGLA) VALUES ('PI','PI') --4
INSERT INTO UF (NOMEUF,SIGLA) VALUES ('RS','RS') --5
SELECT * FROM UF
SELECT * FROM CIDADE

INSERT INTO CIDADE (CODUF_FK) VALUES (2) --2


/*12) IMPRIMA A QUANTIDADE DE CLIENTES QUE MORAM NA CIDADE DE “SANTA FÉ
DO SUL”.*/
INSERT INTO CIDADE (NOMECIDADE,CODUF_FK) VALUES ('SANTA FÉ DO SUL',2)
SELECT * FROM CLIENTE
INSERT INTO SEXO (NOMESEXO) VALUES ('MASCULINO')
INSERT INTO SEXO (NOMESEXO) VALUES ('FEMININO')
INSERT INTO RUA (NOMECIDADE) VALUES ('SANTA FÉ DO SUL',2)


INSERT INTO CLIENTE (NOMECLIENTE,DATANASC,CODSEXO_FK,CODRUA_FK,CODBAIRRO_FK,CODCEP_FK,CODCIDADE_FK,CODTRABALHO_FK,NUMEROCASA) VALUES ('SANTA FÉ DO SUL',2)


/*13) IMPRIMA A QUANTIDADE DE CLIENTES QUE MORAM EM CIDADES QUE
COMEÇAM PELA LETRA “I”.*/
INSERT INTO CLIENTE (NOMECLIENTE,CODCIDADE_FK,DATANASC,SALARIOCLIENTE,NUMEROCASA) VALUES ('Roberto',2,19/06/2000,1000,28)

INSERT INTO CIDADE (NOMECIDADE,CODUF_FK) VALUES ('IBIRÁ',1)
SELECT * FROM CLIENTE WHERE NOMECIDADE LIKE 'I%'
SELECT * FROM CIDADE
SELECT * FROM CLIENTE
/*14) IMPRIMA A QUANTIDADE DE CLIENTES QUE MORAM EM CIDADES QUE
TERMINEM COM A LETRA “L”.*/
INSERT INTO CLIENTE (NOMECLIENTE,CODCIDADE_FK,DATANASC,SALARIOCLIENTE,NUMEROCASA) VALUES ('ALEX',3,13/06/2001,1050,55)

INSERT INTO CIDADE (NOMECIDADE,CODUF_FK) VALUES ('MIRASSOL',1)
SELECT * FROM CIDADE WHERE NOMECIDADE LIKE '%L'
SELECT * FROM CIDADE
SELECT * FROM CLIENTE

--15) IMPRIMA A QUANTIDADE DE CLIENTES QUE SÃO DO SEXO FEMININO.
INSERT INTO CLIENTE (NOMECLIENTE,CODCIDADE_FK,DATANASC,SALARIOCLIENTE,NUMEROCASA,CODSEXO_FK) VALUES ('MARIA',3,13/06/2001,1050,55,2)
INSERT INTO CLIENTE (NOMECLIENTE,CODCIDADE_FK,DATANASC,SALARIOCLIENTE,NUMEROCASA,CODSEXO_FK) VALUES ('LEILA',3,13/06/2001,1050,55,2)
INSERT INTO CLIENTE (NOMECLIENTE,CODCIDADE_FK,DATANASC,SALARIOCLIENTE,NUMEROCASA,CODSEXO_FK) VALUES ('DALVA',3,13/06/2001,1050,55,2)
INSERT INTO SEXO (NOMESEXO) VALUES ('MASCULINO')
INSERT INTO SEXO (NOMESEXO) VALUES ('FEMININO')

SELECT * FROM SEXO

SELECT COUNT(*) FROM CLIENTE WHERE CODSEXO_FK > 1


/*16) IMPRIMA OS DADOS DOS CLIENTES QUE SÃO DO SEXO FEMININO E QUE MORAM
NA CIDADE DE “SANTA FÉ DO SUL”.*/
SELECT * FROM CIDADE
INSERT INTO CIDADE (NOMECIDADE,CODUF_FK) VALUES ('SANTA FÉ DO SUL',1)
INSERT INTO CLIENTE (NOMECLIENTE,CODCIDADE_FK,DATANASC,SALARIOCLIENTE,NUMEROCASA,CODSEXO_FK) VALUES ('PEDRO',4,16/06/2001,1050,55,1)
INSERT INTO CLIENTE (NOMECLIENTE,CODCIDADE_FK,DATANASC,SALARIOCLIENTE,NUMEROCASA,CODSEXO_FK) VALUES ('ANA',4,14/06/2001,1050,55,2)

SELECT * FROM CLIENTE WHERE CODCIDADE_FK = 4
...
INSERT INTO TELEFONE (NUMERO,CODOPERADORA_FK) VALUES ('981507070',1)
INSERT INTO TELEFONE (NUMERO,CODOPERADORA_FK) VALUES ('981508080',1)

INSERT INTO OPERADORA (NOMEOPERADORA) VALUES ('VIVO')
...
INSERT INTO VENDAPRODUTO (DATAVENDA,CODCLIENTE_FK,CODFUNCIONARIO_FK) VALUES ('2022-09-02',6,2)
INSERT INTO ITENSVENDAPRODUTO (CODVENDA_FK,QUANTIDADEITENVENDA,VALORITENSVENDA) VALUES (7,30,600)


/*20) IMPRIMA O VALOR TOTAL DAS VENDAS OCORRIDAS NAS DATA ATUAL. UTILIZE
A FUNÇÃO NOW().*/

INSERT INTO VENDAPRODUTO (DATAVENDA,CODCLIENTE_FK,CODFUNCIONARIO_FK) VALUES ('2023-03-28',7,3)
INSERT INTO ITENSVENDAPRODUTO (CODVENDA_FK,QUANTIDADEITENVENDA,VALORITENSVENDA) VALUES (6,30,600)
...
INSERT INTO SITUACAO (NOMESITUACAO) VALUES ('PAGO')
INSERT INTO SITUACAO (NOMESITUACAO) VALUES ('ATRASADO')


INSERT INTO PARCELAVENDA (DATAVENCIMENTO,VALORPARCELA,CODFUNCIONARIO_FK,CODSITUACAO_FK,CODVENDA_FK) VALUES ('2023-03-26',30,2,1,7)

/*22) IMPRIMA A QUANTDADE DE PARCELAS EM ATRASO DO CLIENTE “MARCOS
ANTONIO ESTREMOTE”.*/
SELECT * FROM CLIENTE
SELECT * FROM CIDADE
INSERT INTO CLIENTE (NOMECLIENTE,CODCIDADE_FK,DATANASC,SALARIOCLIENTE,NUMEROCASA,CODSEXO_FK) VALUES ('MARCOS
ANTONIO ESTREMOTE',4,1969-05-13,20,155,1)
